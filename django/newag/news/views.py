...
def articles_list(request):
    ...
    #    category_form = CategoryForm(request.POST)
        #articles = Article.objects.filter(category__form=F('feed__category'))
        #select * from articles where feed.category = category_form.category
    ...
    #return render(request, 'news/articles_list.html', {'category_form': category_form})
